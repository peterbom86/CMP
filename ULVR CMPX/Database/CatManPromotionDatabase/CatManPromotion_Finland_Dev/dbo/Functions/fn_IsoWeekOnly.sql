CREATE     function fn_IsoWeekOnly(@date datetime)
Returns int
...
If @isoWeek<10 set @string=CAST(@IsoYear AS nvarchar) + '0' + CAST(@isoweek as nvarchar)
If @isoWeek>=10 set @string=CAST(@IsoYear AS nvarchar) + CAST(@isoweek as nvarchar)
