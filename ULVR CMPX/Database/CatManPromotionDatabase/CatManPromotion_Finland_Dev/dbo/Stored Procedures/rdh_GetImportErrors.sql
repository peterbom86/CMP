CREATE PROCEDURE rdh_GetImportErrors
  @FromDate datetime,
  @ToDate datetime
  
AS

SELECT PK_FileImportID, sfi.ImportDate, RIGHT(FileName, PATINDEX('%\%', REVERSE(FileName)) - 1) FileName,
...
WHERE sfi.ImportDate BETWEEN @FromDate AND @ToDate
